...
void Instance::create_instance()
{
    ...
    VK_ASSERT_MSG(vkCreateInstance(&createInfo, nullptr, &handle), "failed to create instance!");
...
void Instance::create_surface()
{
    ...
    VK_ASSERT_MSG(vkCreateWin32SurfaceKHR(handle, &createInfo, nullptr, &surface), 
...
void Instance::setup_debug_messenger()
{
    ...
    VK_ASSERT_MSG(CreateDebugUtilsMessengerEXT(handle, &createInfo, nullptr, &debugMessenger),
...
void Instance::get_instance_version()
{
    ...
    VK_ASSERT_MSG(vkEnumerateInstanceVersion(&instanceVer), "no instance versions???");
